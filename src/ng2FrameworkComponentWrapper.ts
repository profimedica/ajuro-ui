...
export class Ng2FrameworkComponentWrapper extends BaseComponentWrapper<WrapableInterface> implements FrameworkComponentWrapper {
    ...
    createWrapper(OriginalConstructor: { new (): any }): WrapableInterface{
        let that = this;
        class DynamicAgNg2Component extends BaseGuiComponent<any, AjuroFrameworkComponent<any>> implements WrapableInterface{
            init(params: any): void {
                super.init(params);
                this._componentRef.changeDetectorRef.detectChanges();
            }

            protected createComponent(): ComponentRef<AjuroFrameworkComponent<any>> {
...
abstract class BaseGuiComponent<P, T extends AjuroFrameworkComponent<P>> {
    protected _params: P;
