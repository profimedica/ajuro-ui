...
import {AjuroGridColumn} from "./ajuroColumn";
...
export class AjuroGridNg2 implements AfterViewInit {
    ...
    @ContentChildren(AjuroGridColumn) public columns: QueryList<AjuroGridColumn>;
